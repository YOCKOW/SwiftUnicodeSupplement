/* *************************************************************************************************
 UnicodeSupplementTests.swift
   © 2018,2020-2021,2023-2024,2026 YOCKOW.
...
@Suite struct UnicodeSupplementTests {
  ...
  @Test func properties() {
    func __assert(
      _ scalar: Unicode.Scalar,
      _ keyPath: KeyPath<Unicode.Scalar.LatestProperties, Bool>,
      expected: Bool,
    ...
    func _assert(_ scalar: Unicode.Scalar, expected: Bool, sourceLocation: SourceLocation = #_sourceLocation) {
      __assert(scalar, presentKeyPath, expected: expected, sourceLocation: sourceLocation)
    }
